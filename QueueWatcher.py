...
class QueueWatcher:
    ...
    def get_queueing_image(self, hide_after_screenshot=False, time_to_wait=0.5, fullscreen=False, fullscreen_time_to_wait=5):
    ...
    def run(self):
        ...
        self.get_queueing_image(fullscreen=True)
